...
public class WorkerController {
    ...
    public Result update(@RequestBody Worker worker) {
        ...
        UserMapper userMapper = SpringContextUtil.getBean(UserMapper.class);
        User dbUser = userMapper.selectById(worker.getUserId());
        dbUser.setName(worker.getName());
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        QueryWrapper<Worker> queryWrapper = new QueryWrapper<Worker>().orderByDesc("id");
        ...
        return Result.success(workerService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Worker信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Worker> list = reader.readAll(Worker.class);

        workerService.saveBatch(list);
        return Result.success();
    }
