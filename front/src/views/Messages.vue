...
<template>
  <div style="background-color: #ffffff;padding: 10px;border-radius: 10px;margin-top: 20px;">
    ...
    <div style="margin: 10px 0">
      ...
      <el-table-column label="通知内容"><template #default="scope"><el-button @click="view(scope.row.content)">查看</el-button></template></el-table-column>
      ...
      <el-table-column prop="isread" label="是否已读"></el-table-column>
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('messages.edit')">修改<el-icon style="vertical-align: middle"><Edit /></el-icon></el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="消息通知信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        <el-form-item label-width="100" prop="content" label="通知内容">
    ...
    />
        ...
        <el-form-item label-width="100" prop="time" label="通知时间">
        ...
        <el-form-item label-width="100" prop="isread" label="是否已读">
