  ...
  <div>
    ...
    <div style="width:85%;margin: 0 auto;margin-bottom: 50px;">
        <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;">
          <span style="font-size: 14px;margin-right: 20px;">当前位置：首页 > 维修单列表</span>
        </div>

        <div style="padding-bottom: 15px ;border-bottom: 3px solid #CC9999; text-align: left;display: flex;">
          <span style="font-weight: bold; font-size: 24px;float: left;flex: 3;color: #CC9999;">维修单列表</span>

          <div style="margin-top: 10px;float: right;flex: 1;">
            <el-input style="width: 200px" placeholder="查询维修单列表" v-model="state.searchKey" clearable></el-input>
        ...
        <div style="display:flex;">
                    <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;line-height: 30px;flex: 1;margin-right: 10px;">
                        <div style="margin-right: 10px;" class="categorybar">
                            <a href="javascript:void(0)" @click="getCategory('all')">全部维修单列表</a>
                        </div>
