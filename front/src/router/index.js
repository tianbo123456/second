...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/Register-worker.vue')
    },
    {
      path: '/404',
      name: '404',
	...
	// 前台页面路由
    {
      ...
      children: [
        ...
        { path: 'repairs', name: 'repairs', component: () => import('../views/front/Repairs.vue') },
        { path: 'preorders', name: 'preorders', component: () => import('../views/front/Preorders.vue') },
        { path: 'orders', name: 'orders', component: () => import('../views/front/Orders.vue') },
          ...
          { path: 'repairs-detail', name: 'repairs-detail', component: () => import('../views/front/RepairsDetail.vue') },
        { path: 'messages', name: 'messages', component: () => import('../views/front/Messages.vue') },
      ]
    }
  ]
})
